...
import (
	...
	appv1 "github.com/fzf-labs/ai-boilerplate-backend/api/app/v1"
...
func NewHTTPServer(
	...
	appv1.RegisterAppVersionHTTPServer(srv, appV1AppVersionService)
	// 自定义路由
