...
func newActivity(db *gorm.DB, opts ...gen.DOOption) activity {
	...
	_activity.activityDo.UseModel(&ai_boilerplate_model.Activity{})
	...
	_activity.TenantID = field.NewString(tableName, "tenant_id")
	_activity.Title = field.NewString(tableName, "title")
	_activity.ImageURL = field.NewString(tableName, "image_url")
	_activity.LinkURL = field.NewString(tableName, "link_url")
	_activity.LinkType = field.NewString(tableName, "link_type")
	_activity.Sort = field.NewInt32(tableName, "sort")
	_activity.Status = field.NewInt16(tableName, "status")
...
func (a *activity) updateTableName(table string) *activity {
	...
	a.LinkURL = field.NewString(table, "link_url")
	a.LinkType = field.NewString(table, "link_type")
...
func (a *activity) fillFieldMap() {
	...
	a.fieldMap["link_url"] = a.LinkURL
	a.fieldMap["link_type"] = a.LinkType
...
func (a activityDo) Create(values ...*ai_boilerplate_model.Activity) error {
	if len(values) == 0 {
		return nil
	}
...
func (a activityDo) CreateInBatches(values []*ai_boilerplate_model.Activity, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a activityDo) Save(values ...*ai_boilerplate_model.Activity) error {
	if len(values) == 0 {
		return nil
	}
...
func (a activityDo) First() (*ai_boilerplate_model.Activity, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*ai_boilerplate_model.Activity), nil
	}
}

func (a activityDo) Take() (*ai_boilerplate_model.Activity, error) {
...
func (a activityDo) Last() (*ai_boilerplate_model.Activity, error) {
...
func (a activityDo) Find() ([]*ai_boilerplate_model.Activity, error) {
	result, err := a.DO.Find()
	return result.([]*ai_boilerplate_model.Activity), err
}

func (a activityDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*ai_boilerplate_model.Activity, err error) {
	buf := make([]*ai_boilerplate_model.Activity, 0, batchSize)
...
func (a activityDo) FindInBatches(result *[]*ai_boilerplate_model.Activity, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a activityDo) FirstOrInit() (*ai_boilerplate_model.Activity, error) {
...
func (a activityDo) FirstOrCreate() (*ai_boilerplate_model.Activity, error) {
...
func (a activityDo) FindByPage(offset int, limit int) (result []*ai_boilerplate_model.Activity, count int64, err error) {
...
func (a activityDo) Delete(models ...*ai_boilerplate_model.Activity) (result gen.ResultInfo, err error) {
