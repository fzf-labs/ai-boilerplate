...
export type GetUserMessageCategoryCountsReply = {
  /** 交易信息未读数 */
...
export type GetUserMessageCategoryCountsResponses = {
  /**
   * A successful response.
   */
  200: GetUserMessageCategoryCountsReply;
  /**
...
export type UpdateUserMessageReadReply = object;

export type UpdateUserMessageReadReq = {
  /** id */
  id: string;
};

export type UpdateUserMessageReadResponses = {
  /**
   * A successful response.
   */
  200: UpdateUserMessageReadReply;
  /**
   * An unexpected error response.
   */
  default: Status;
