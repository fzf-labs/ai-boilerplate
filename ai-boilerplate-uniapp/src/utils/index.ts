 ...
 * redirectPath 如 '/pages/discover/index'
 */
export function currRoute() {
  ...
  // eg: /pages/login/login?redirect=%2Fpages%2Fdiscover%2Findex (小程序)
  // eg: /pages/login/login?redirect=%2Fpages%2Fdiscover%2Findex%3Ftab%3Darticle(h5)
